...
copy lib\derbyclient.jar .
jarsigner -keystore myKeystore -signedjar agendae.jar -keypass abc123 -storepass 123abc agendae0.jar myself
jarsigner -keystore myKeystore -keypass abc123 -storepass 123abc derbyclient.jar myself
jarsigner -verify agendae.jar derbyclient.jar
